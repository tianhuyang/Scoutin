...
public class PictureHome {
	...
	public Picture findById(long id) {
		...
		try {
			Picture instance = (Picture) sessionFactory.getCurrentSession()
					.get("com.scoutin.entities.Picture", id);
			if (instance == null) {
	...
	public List<Picture> findByExample(Picture instance) {
		log.debug("finding Picture instance by example");
		try {
			List<Picture> results = (List<Picture>) sessionFactory
					.getCurrentSession()
					.createCriteria("com.scoutin.entities.Picture")
