...
public class Account implements java.io.Serializable {
	...
	public Account(int accountId, String password, String email,
			String username, String facebookId, String twitterId,
			Date createdTime, Date updatedTime, Set<Album> albums, Stat stat,
			Profile profile, Set<Follower> followersForFollowingId,
			Set<Card> cards, Set<Card> cards_1, Set<Comment> comments,
