...
public class StatHome {
	...
	public List<Stat> findByExample(Stat instance) {
		log.debug("finding Stat instance by example");
		try {
			List<Stat> results = (List<Stat>) sessionFactory
					.getCurrentSession()
					.createCriteria("com.scoutin.entities.Stat")
