...
public class Card implements java.io.Serializable {
	...
	public Card(long cardId, Card card, String title, String description,
			...
			Set<Picture> pictures, Set<Account> accounts, Set<Album> albums,
			Set<Category> categories, Set<Card> cards, Set<Account> accounts_1,
